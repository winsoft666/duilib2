...
public:
	...
	void PaintForeColor(HDC hDC)
	{
		...
		g.FillPie(&brush, rcPos.left, rcPos.top, rcPos.right - rcPos.left, rcPos.bottom - rcPos.top, (Gdiplus::REAL)nStartDegree, (Gdiplus::REAL)nSweepDegree);

		Gdiplus::SolidBrush brushbk(0xFFFFFFFF);
		g.FillPie(&brushbk, rcPos.left + 10, rcPos.top + 10, rcPos.right - rcPos.left - 20, rcPos.bottom - rcPos.top - 20, 0.f, 360.f);
...
class CMyComboUI : public CComboBoxUI
{
