...
namespace DuiLib {
    ...
    bool CTreeViewUI::Add( CTreeNodeUI *pControl ) {
        ...
        pControl->m_OnNotifyDelegate += MakeDelegate(this, &CTreeViewUI::OnDBClickItem);
        pControl->GetFolderButton()->m_OnNotifyDelegate += MakeDelegate(this, &CTreeViewUI::OnFolderChanged);
        pControl->GetCheckBox()->m_OnNotifyDelegate += MakeDelegate(this, &CTreeViewUI::OnCheckBoxChanged);
