...
#include <textserv.h>
    ...
    class CTxtWinHost : public ITextHost {
      public:
        ...
        void SetWordWrap(BOOL fIsWordWrap);
        BOOL IsReadOnly();
        ...
        BOOL GetAllowBeep();
        void SetAllowBeep(BOOL fIsAllowBeep);
    ...
    void CTxtWinHost::SetWordWrap(BOOL fIsWordWrap) {
        fWordWrap = fIsWordWrap;
    ...
    void CTxtWinHost::SetAllowBeep(BOOL fIsAllowBeep) {
        fAllowBeep = fIsAllowBeep;
