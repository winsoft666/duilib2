...
namespace DuiLib {
    ...
    void CScrollBarUI::PaintButton1(HDC hDC) {
        ...
        int d1 = MulDiv(m_rcButton1.left - m_rcItem.left, 100, m_pManager->GetDPIObj()->GetScale());
        int d2 = MulDiv(m_rcButton1.top - m_rcItem.top, 100, m_pManager->GetDPIObj()->GetScale());
        int d3 = MulDiv(m_rcButton1.right - m_rcItem.left, 100, m_pManager->GetDPIObj()->GetScale());
        int d4 = MulDiv(m_rcButton1.bottom - m_rcItem.top, 100, m_pManager->GetDPIObj()->GetScale());
    ...
    void CScrollBarUI::PaintButton2(HDC hDC) {
        ...
        int d1 = MulDiv(m_rcButton2.left - m_rcItem.left, 100, m_pManager->GetDPIObj()->GetScale());
        int d2 = MulDiv(m_rcButton2.top - m_rcItem.top, 100, m_pManager->GetDPIObj()->GetScale());
        int d3 = MulDiv(m_rcButton2.right - m_rcItem.left, 100, m_pManager->GetDPIObj()->GetScale());
        int d4 = MulDiv(m_rcButton2.bottom - m_rcItem.top, 100, m_pManager->GetDPIObj()->GetScale());
        m_sImageModify.Empty();
        m_sImageModify.Format(_T("dest='%d,%d,%d,%d'"), d1, d2, d3, d4 );
    ...
    void CScrollBarUI::PaintThumb(HDC hDC) {
        ...
        int d1 = MulDiv(m_rcThumb.left - m_rcItem.left, 100, m_pManager->GetDPIObj()->GetScale());
        int d2 = MulDiv(m_rcThumb.top - m_rcItem.top, 100, m_pManager->GetDPIObj()->GetScale());
        int d3 = MulDiv(m_rcThumb.right - m_rcItem.left, 100, m_pManager->GetDPIObj()->GetScale());
        int d4 = MulDiv(m_rcThumb.bottom - m_rcItem.top, 100, m_pManager->GetDPIObj()->GetScale());
        m_sImageModify.Empty();
        m_sImageModify.Format(_T("dest='%d,%d,%d,%d'"), d1, d2, d3, d4);
    ...
    void CScrollBarUI::PaintRail(HDC hDC) {
        ...
        if( !m_bHorizontal ) {
            int d1 = MulDiv(m_rcThumb.left - m_rcItem.left, 100, m_pManager->GetDPIObj()->GetScale());
            int d2 = MulDiv((m_rcThumb.top + m_rcThumb.bottom) / 2 - m_rcItem.top - m_cxyFixed.cx / 2, 100, m_pManager->GetDPIObj()->GetScale());
            int d3 = MulDiv(m_rcThumb.right - m_rcItem.left, 100, m_pManager->GetDPIObj()->GetScale());
            int d4 = MulDiv((m_rcThumb.top + m_rcThumb.bottom) / 2 - m_rcItem.top + m_cxyFixed.cx - m_cxyFixed.cx / 2, 100, m_pManager->GetDPIObj()->GetScale());
            m_sImageModify.Format(_T("dest='%d,%d,%d,%d'"), d1, d2, d3, d4);
        } else {
            int d1 = MulDiv((m_rcThumb.left + m_rcThumb.right) / 2 - m_rcItem.left - m_cxyFixed.cy / 2, 100, m_pManager->GetDPIObj()->GetScale());
            int d2 = MulDiv(m_rcThumb.top - m_rcItem.top, 100, m_pManager->GetDPIObj()->GetScale());
            int d3 = MulDiv((m_rcThumb.left + m_rcThumb.right) / 2 - m_rcItem.left + m_cxyFixed.cy - m_cxyFixed.cy / 2, 100, m_pManager->GetDPIObj()->GetScale());
            int d4 = MulDiv(m_rcThumb.bottom - m_rcItem.top, 100, m_pManager->GetDPIObj()->GetScale());
            m_sImageModify.Format(_T("dest='%d,%d,%d,%d'"), d1, d2, d3, d4);
        }
