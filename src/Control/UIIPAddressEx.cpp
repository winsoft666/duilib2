...
namespace DuiLib {
    ...
    void CIPAddressUI::GetNumInput(TCHAR chKey) {
    ...
    void CIPAddressUI::CharToInt() {
        TCHAR szNum[MAX_PATH] = {0};
        lstrcpyn(szNum, m_strNum, MAX_PATH);
    ...
    void CIPAddressUI::SetIP(LPCWSTR lpIP) {
        static int nPos = 0;
        wstring curStr;
