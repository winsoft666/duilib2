...
#define UILIST_MAX_COLUMNS 32
    ...
    typedef struct tagTListInfoUI {
        ...
        bool bRSelected;
        DWORD dwRowLineHeight;
        DWORD dwColumnLineWidth;
        DWORD dwTextColor;
        DWORD dwBkColor;
    ...
    class UILIB_API CListUI : public CVerticalLayoutUI, public IListUI {
      ...
      public:
        ...
        bool GetItemScrollSelect();
        void SetItemScrollSelect(bool bScrollSelect);
        int GetCurSel() const;
        ...
        // Jeffery: 若bResetSelIndex为false则删除成功后将没有选中项；否则会自动计算选中项
        //
        ...
        void SetItemRowLineHeight(DWORD dwHeight);
        void SetItemColumnLineWidth(DWORD dwWidth);
        bool IsItemShowHtml();
    ...
    class UILIB_API CListHeaderUI : public CHorizontalLayoutUI {
      ...
      public:
        ...
        void SetPercentageHeader(bool bIsPercentage);
        bool IsPercentageHeader() const;

      private:
        bool m_bIsPercentageHeader;
    };
    ...
    class UILIB_API CListHeaderItemUI : public CContainerUI {
      ...
      public:
        ...
        bool GetSepWidthAdaptDpiScale();
        void SetSepWidthAdaptDpiScale(bool adapt);
      ...
      protected:
        ...
        UINT m_uButtonState;
        int m_iSepWidth;
        bool m_bSepWidthAdaptDpiScale; // Jeffery: 分隔图片的宽度是否适应DPI缩放
        DWORD m_dwTextColor;
        int m_iFont;
        UINT m_uTextStyle;
        bool m_bShowHtml;
