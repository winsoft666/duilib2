...
namespace DuiLib {
	...
	public:
		CEventSource m_OnInitDelegate;
		CEventSource m_OnDestroyDelegate;
		CEventSource m_OnSizeDelegate;
		CEventSource m_OnEventDelegate;
		CEventSource m_OnNotifyDelegate;
